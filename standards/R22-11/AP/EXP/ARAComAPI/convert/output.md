...
5.  [Detailed API description](#detailed-api-description) 27
    ...
    7.  [Communication Groups](#communication-groups) 94
        ...
        4.  [Special Topics](#special-topics) 96
            ...
            1.  [Architecture](#_bookmark169) 96
...
7.  Middleware for Real-time and Embedded Systems []{#_bookmark7 .anchor}<http://doi.acm.org/10.1145/508448.508472>

8.  Patterns, Frameworks, and Middleware: Their Synergistic Relationships []{#_bookmark8 .anchor}<http://dl.acm.org/citation.cfm?id=776816.776917>
...
11. Serialization and Unserialization []{#_bookmark11 .anchor}<https://isocpp.org/wiki/faq/serialization>

12. Copying and Comparing: Problems and Solutions []{#_bookmark12 .anchor}<http://dx.doi.org/10.1007/3-540-45102-1_11>
...
> 3
>
> 4 static ara::core::Result\<InstanceIdentifier\>
>
> 5 Create(StringView serializedFormat) noexcept;
>
> 6
>
> 7 explicit InstanceIdentifier
>
> 8 (ara::core::StringView serializedFormat);
>
> 9 ara::core::StringView ToString() const;
>
> 10 bool operator==(const InstanceIdentifier& other) const;
>
> 11 bool operator\<(const InstanceIdentifier& other) const;
>
> 12 InstanceIdentifier& operator=(const InstanceIdentifier& other);
>
> 13 };
>
...
>
> 1 []{#_bookmark93 .anchor}class InstanceSpecifier final
>
> 2 {
>
> 3 public:
>
> 4 // ctor to build specifier from AUTOSAR short name identifier
>
> 5 // with '/' as separator between package names
>
> 6 static Result\<InstanceSpecifier\> Create(StringView metaModelIdentifier);
>
> 7 explicit InstanceSpecifier(StringView metaModelIdentifier);
>
...
>
> 13 StringView ToString() const noexcept;
>
> 14 bool operator==(const InstanceSpecifier& other) const noexcept;
>
> 15 bool operator==(StringView other) const noexcept;
>
> 16 bool operator!=(const InstanceSpecifier& other) const noexcept;
>
> 17 bool operator!=(StringView other) const noexcept;
>
> 18 bool operator\<(const InstanceSpecifier& other) const noexcept;
>
> 19 };
>
...
>
> 1 []{#_bookmark94 .anchor}namespace ara {
>
> 2 namespace com {
>
> 3 namespace runtime {
>
> 4 ara::core::Result\<ara::com::InstanceIdentifierContainer\> ResolveInstanceIDs (ara::core::InstanceSpecifier modelName);
>
> 5 }
>
> 6 }
...
>
> 1 []{#_bookmark100 .anchor}RadarService {
>
...
> 1 []{#_bookmark104 .anchor}class RadarServiceProxy {
>
> 2 public:
>
> 3 /\*\*
...
>
> 10 \* Since the platform vendor is responsible for creation of handles, the
>
> 11 \* ctor signature is not given as it is not of interest to the user.
>
> 13 class HandleType {
>
> 14 /\*\*
>
> 15 \* \\brief Two ServiceHandles are considered equal if they represent
>
> 16 \* the same service instance.
>
> 17 \*
>
> 18 \* \\param other
...
> 21 \*/
>
> 22 inline bool operator==(const HandleType &other) const;
>
> 23 const ara::com::InstanceIdentifier &GetInstanceId() const;
>
> 24 };
>
> 25
...
> 26 /\*\*
>
> 27 \* StartFindService does not need an explicit version parameter as this
>
> 28 \* is internally available in ProxyClass.
>
> 29 \* That means only compatible services are returned.
>
> 30 \*
>
> 31 \* \\param handler this handler gets called any time the service
>
> 32 \* availability of the services matching the given
>
> 33 \* instance criteria changes. If you use this variant of
>
> 34 \* FindService, the Communication Management has to
>
...
> 44 \*/
>
> 45 static ara::core::Result\<ara::com::FindServiceHandle\> StartFindService(
>
...
> 54 \*/
>
> 55 static ara::core::Result\<ara::com::FindServiceHandle\> StartFindService
>
> (
>
...
> 59 /\*\*
>
> 60 \* Method to stop finding service request (see above)
>
> 61 \*/
>
> 62 static void StopFindService(ara::com::FindServiceHandle handle);
>
> 63
>
> 64 /\*\*
>
> 65 \* Opposed to StartFindService(handler, instance) this version
>
> 66 \* is a \"one-shot\" find request, which is:
>
> 68 \* and a result list of matching service instances is
>
> 69 \* available. (list may be empty, if no matching service
>
> 70 \* instances currently exist)
>
> 71 \* - does reflect the availability at the time of the method
>
> 72 \* call. No further (background) checks of availability are
>
> 73 \* done.
>
> 74 \*
>
> 75 \* \\param instanceId which instance of the service type defined
>
> 76 \* by T shall be searched/found.
>
> 77 \*
>
> 78 \*/
>
> 79 static ara::core::Result\<ara::com::ServiceHandleContainer
>
> 80 \<RadarServiceProxy::HandleType\>\>
>
> 81 FindService(ara::com::InstanceIdentifier instanceId);
>
> 82
>
> 83 /\*\*
>
> 84 \* This is an overload of the FindService method using an
>
> 85 \* instance specifier, which gets resolved via service instance
>
> 86 \* manifest.
>
> 87 \*/
>
> 88 static ara::core::Result\<ara::com::ServiceHandleContainer
>
> 89 \<RadarServiceProxy::HandleType\>\>
>
> 90 FindService(ara::core::InstanceSpecifier instanceSpec);
>
> 91
>
> 92 /\*\*
>
> 93 \* \\brief The proxy can only be created using a specific
>
> 94 \* handle which identifies a service.
>
> 95 \*
>
> 96 \* This handle can be a known value which is defined at
>
> 97 \* deployment or it can be obtained using the
>
> 98 \* ProxyClass::FindService method.
>
> 99 \*
>
> 100 \* \\param handle The identification of the service the
>
> 101 \* proxy should represent.
>
> 102 \*/
>
> 103 explicit RadarServiceProxy(HandleType &handle);
>
> 104
>
> 105 /\*\*
>
> 106 \* proxy instances are not copy constructible.
>
> 107 \*/
>
> 108 RadarServiceProxy(RadarServiceProxy &other) = delete;
>
> 109
>
> 110 /\*\*
>
> 111 \* proxy instances are not copy assignable
>
> 112 \*/
>
> 113 RadarServiceProxy& operator=(const RadarServiceProxy &other) = delete;
>
> 114
>
> 115 /\*\*
>
> 116 \* \\brief Public member for the BrakeEvent
>
> 117 \*/
>
> 118 events::BrakeEvent BrakeEvent;
>
> 119
>
> 120 /\*\*
>
> 121 \* \\brief Public Field for UpdateRate
>
> 122 \*/
>
> 124
...
> 125 /\*\*
>
> 126 \* \\brief Public member for the Calibrate method
>
> 127 \*/
>
> 128 methods::Calibrate Calibrate;
>
> 129
>
> 130 /\*\*
>
> 131 \* \\brief Public member for the Adjust method
>
> 132 \*/
>
> 133 methods::Adjust Adjust;
>
> 134
>
> 135 /\*\*
>
> 136 \* \\brief Public member for the LogCurrentState fire-and-forget method
>
> 137 \*/
>
> 138 methods::LogCurrentState LogCurrentState;
>
> 139 };
>
...
> 6
>
> 7 void radarServiceAvailabilityHandler(ServiceHandleContainer\< RadarServiceProxy::HandleType\> curHandles, FindServiceHandle handle) {
>
> 8 for (RadarServiceProxy::HandleType handle : curHandles) {
>
> 9 if (handle.GetInstanceId() == myRadarProxy-\>GetHandle(). GetInstanceId()) {
>
> 10 /\*\*
>
> 11 \* This call on the proxy instance shall NOT lead to an exception,
>
> 12 \* regarding service instance not reachable, since proxy instance
>
...
> 20 \*/
>
> 21 ara::core::Result\<void\> Subscribe(size_t maxSampleCount);
>
> 22
>
> 23 /\*\*
...
> 41 \*/
>
> 42 size_t GetFreeSampleCount() const noexcept;
>
> 43
>
> 44 /\*\*
...
> 63 \*/
>
> 64 ara::core::Result\<void\> SetReceiveHandler(ara::com::EventReceiveHandler
>
> handler);
>
> 65
...
> 68 \*/
>
> 69 ara::core::Result\<void\> UnsetReceiveHandler();
>
> 70
>
> 71 /\*\*
...
> 84 \*/
>
> 85 ara::core::Result\<void\> SetSubscriptionStateChangeHandler(
>
...
> 7 \*/
>
> 8 ara::core::Result\<void\> Subscribe(size_t maxSampleCount);
>
...
>
> 3 \* by the Communication Management implementation as soon as the
>
> 4 \* subscription state of this event has changed.
>
> 5 \*
>
...
> 7 \*/
>
> 8 ara::core::Result\<void\> SetSubscriptionStateChangeHandler
>
> 9 (ara::com::SubscriptionStateChangeHandler handler);
>
> Here the user may register a handler function, which has to fulfill the following signa- ture:
>
> 1 enum class SubscriptionState { kSubscribed, kNotSubscribed, kSubscriptionPending };
>
> 2 using SubscriptionStateChangeHandler = std::function\<void( SubscriptionState)\>;
>
...
>
> 1 ara::core::Result\<void\> SetReceiveHandler(ara::com::EventReceiveHandler handler);
>
...
>
> 1 []{#_bookmark115 .anchor}#include \"RadarServiceProxy.hpp\"
>
> 2 #include \<memory\>
>
> 3 #include \<deque\>
...
>
> 24 std::deque\<SamplePtr\<const proxy::events::BrakeEvent::SampleType\>\>& samples) {
>
> 25 // do whatever with those BrakeEvent samples \...
>
> 26 }
>
> 27
...
> 28 /\*\*
>
> 29 \* \\brief event reception handler for BrakeEvent events, which we register to get informed about new events.
>
> 30 \*/
>
...
> 32 /\*\*
>
> 33 \* we get newly arrived BrakeEvent events into our process space.
>
> 34 \* For each sample we get passed in, we check for a certain property
>
> 35 \* \"active\" and if it fulfills the check, we move it into our Last10- storage.
>
> 36 \* So this few lines basically implement filtering and a LastN policy.
>
> 37 \*/
>
> 38 myRadarProxy-\>BrakeEvent.GetNewSamples(
>
> 39 \[\](SamplePtr\<proxy::events::BrakeEvent::SampleType\> samplePtr) {
>
> 40 if(samplePtr-\>active) {
>
> 41 lastNActiveSamples.push_back(std::move(samplePtr));
>
> 42 if (lastNActiveSamples.size() \> 10)
>
> 43 lastNActiveSamples.pop_front();
>
> 44 }
>
> 45 });
...
> 46
>
> 47 // \... now process those samples \...
>
> 48 processLastBrakeEvents(lastNActiveSamples);
>
> 49 }
>
> 50
...
>
> 53 /\* Instance Specifier from model \*/
>
> 54 ara::core::InstanceSpecifier instspec {\...}
>
> 55
>
> 56 auto handles = proxy::RadarServiceProxy::FindService(instspec);
>
> 57
>
> 58 if (!handles.empty()) {
>
> 59 /\* we have at least one valid handle - we are not very particular
>
> 60 \* here and take the first one to create our proxy \*/
>
> 61 myRadarProxy = std::make_unique\<proxy::RadarServiceProxy\>(handles
>
> \[0\]);
>
> 62
>
> 63 /\* we are interested in receiving the event \"BrakeEvent\" - so we
>
> 64 \* subscribe for it. We want to access up to 10 events, since our
>
> 65 \* sample algo averages over at most 10.\*/
>
> 66 myRadarProxy-\>BrakeEvent.Subscribe(10);
>
> 67
>
> 68 /\* whenever new BrakeEvent events come in, we want be called, so we
>
> 69 \* register a callback for it!
>
> 70 \* Note: If the entity we would subscribe to, would be a field
>
> 71 \* instead of an event, it would be crucial, to register our
>
> 72 \* reception handler BEFORE subscribing, to avoid race conditions.
>
> 73 \* After a field subscription, you would get instantly so called
>
> 74 \* \"initial events\" and to be sure not to miss them, you should care
>
> 75 \* for that your reception handler is registered before.\*/
>
> 76 myRadarProxy-\>BrakeEvent.SetReceiveHandler(
>
...
> 78
>
> 79 // \... wait for application shutdown trigger by application exec mgmt.
>
> 80 }
>
...
>
> 4 timeout, ///\< the shared state did not become ready before the specified timeout has passed
>
> 5 };
>
> 6
...
> 25 \*
>
> 26 \* \@returns value of type T
>
> 27 \* \@error Domain:error the error that has been put into the
>
> 28 \* corresponding Promise via Promise::SetError
>
> 29 \*
>
> 30 \*/
...
> 32
>
> 34 \* \@brief Get the result.
>
> 35 \*
>
> 36 \* Similar to get(), this call blocks until the value or an error is
>
> 37 \* available. However, this call will never throw an exception.
>
> 38 \*
>
> 39 \* \@returns a Result with either a value or an error
>
> 40 \* \@error Domain:error the error that has been put into the
>
> 41 \* corresponding Promise via Promise::SetError
>
> 42 \*
>
> 43 \*/
>
> 44 Result\<T, E\> GetResult() noexcept;
>
> 45
>
> 46 /\*\*
>
> 47 \* \@brief Checks if the Future is valid, i.e. if it has a shared state.
>
> 48 \*
>
> 49 \* This function shall behave the same as the corresponding std::future
>
> 50 \* function.
>
> 51 \*
>
> 52 \* \@returns true if the Future is usable, false otherwise
>
> 53 \*/
>
...
> 56 /\*\*
>
> 57 \* \@brief Wait for a value or an error to be available.
>
> 58 \*
>
> 59 \* This function shall behave the same as the corresponding std::future
>
> 60 \* function.
>
> 61 \*/
...
> 64 /\*\*
>
> 65 \* \@brief Wait for the given period, or until a value or an error is
>
> 66 \* available.
>
> 67 \*
>
> 68 \* This function shall behave the same as the corresponding std::future
>
> 69 \* function.
>
> 70 \*
>
> 71 \* \@param timeoutDuration maximal duration to wait for
>
> 72 \* \@returns status that indicates whether the timeout hit or if a value
>
> 73 \* is available
>
> 74 \*/
...
>
> 76 future_status wait_for(std::chrono::duration\<Rep, Period\> const& timeoutDuration) const;
>
> 77
>
> 78 /\*\*
>
> 79 \* \@brief Wait until the given time, or until a value or an error is
>
> 80 \* available.
>
> 81 \*
>
> 82 \* This function shall behave the same as the corresponding std::future
>
> 83 \* function.
>
> 84 \*
>
> 85 \* \@param deadline latest point in time to wait
>
> 86 \* \@returns status that indicates whether the time was reached or if a
>
> 87 \* value is available
>
> 89 template \<typename Clock, typename Duration\>
>
> 90 future_status wait_until(const std::chrono::time_point\<Clock, Duration
>
> \>& deadline) const;
>
> 91
...
> 92 /\*\*
>
> 93 \* \@brief Register a callable that gets called when the Future becomes
>
> 94 \* ready.
>
> 95 \*
>
> 96 \* When \@a func is called, it is guaranteed that get() and GetResult()
>
> 97 \* will not block.
>
> 98 \*
>
> 99 \* \@a func may be called in the context of this call or in the context
>
> 100 \* of Promise::set_value() or Promise::SetError() or somewhere else.
>
> 101 \*
>
> 102 \* The return type of \@a then depends on the return type of \@a func
>
> 103 \* (aka continuation).
>
> 104 \*
>
> 105 \* Let U be the return type of the continuation (i.e. a type equivalent
>
> 106 \* to std::result_of_t\<std::decay_t\<F\>(Future\<T,E\>)\>).
>
> 107 \* - If U is Future\<T2,E2\> for some types T2, E2, then the return
>
> 108 \* type of \@a then() is Future\<T2,E2\>. This is known as implicit
>
> 109 \* Future unwrapping.
>
> 110 \* - If U is Result\<T2,E2\> for some types T2, E2, then the return
>
> 111 \* type of \@a then() is Future\<T2,E2\>. This is known as implicit
>
> 112 \* Result unwrapping.
>
> 113 \* - Otherwise it is Future\<U,E\>.
>
> 114 \*
>
> 115 \* \@param func a callable to register
>
> 116 \* \@returns a new Future instance for the result of the continuation
>
> 117 \*/
>
> 118 template \<typename F\>
>
> 119 auto then(F&& func) -\> Future\<SEE_COMMENT_ABOVE\>;
>
> 120
>
> 121 /\*\*
>
> 122 \* \@brief Return whether the asynchronous operation has finished.
>
> 123 \*
>
> 124 \* If this function returns true, get(), GetResult() and the wait calls
>
> 125 \* are guaranteed not to block.
>
> 126 \*
>
> 127 \* The behavior of this function is undefined if valid() returns false.
>
> 128 \*
>
> 129 \* \@returns true if the Future contains a value or an error, false
>
> 130 \* otherwise
>
> 131 \*/
>
> 132 bool is_ready() const;
>
> 133 };
>
...
>
> 7 Future\<Calibrate::Output\> callFuture = service.Calibrate( myConfigString);
>
> 8
>
> 9 /\*\*
...
>
> 9 \* for notifications the details of the interfaces described there.
>
> 10 \*/
>
> 11 ara::core::Result\<void\> Subscribe(size_t maxSampleCount);
>
> 12 size_t GetFreeSampleCount() const noexcept;
>
> 13 ara::com::SubscriptionState GetSubscriptionState() const;
>
> 14 void Unsubscribe();
>
> 15 ara::core::Result\<void\> SetReceiveHandler(ara::com::EventReceiveHandler handler);
>
> 16 ara::core::Result\<void\> UnsetReceiveHandler();
>
> 17 ara::core::Result\<void\> SetSubscriptionStateChangeHandler(ara::com:: SubscriptionStateChangeHandler handler);
>
...
> 3 \*/
>
> 4 ara::core::Result\<void\> Subscribe();
>
...
> 1 /\*\*
>
> 2 \* \\brief Get number of triggeres if any recieved.
>
> 3 \*
>
> 4 \* \\return Result, which indicates the number of new triggers
>
> 5 \* (zero means no new trigger has been recieved).
>
> 6 \*/
>
> 7 size_t GetNewTriggers();
>
...
> 1 []{#_bookmark127 .anchor}class RadarServiceSkeleton {
>
> 2 public:
>
> 3 /\*\*
...
> 6 \*/
>
> 7 RadarServiceSkeleton(ara::com::InstanceIdentifier instanceId,
>
...
> 11 /\*\*
>
> 12 \* Exception-less ctor taking instance identifier as parameter
>
> 13 \* and having default request processing mode kEvent.
>
> 14 \*/
>
> 15 static ara::core::Result\<RadarServiceSkeleton\> Create(
>
> 16 const ara::core::InstanceIdentifier &instanceID,
>
> 17 ara::com::MethodCallProcessingMode mode =
>
> 18 ara::com::MethodCallProcessingMode::kEvent) noexcept;
>
> 19
>
> 20 /\*\*
>
> 21 \* Ctor taking instance identifier container as parameter and having
>
> 22 \* default request processing mode kEvent.
>
> 23 \* This specifically supports multi-binding.
>
> 24 \*/
>
> 25 RadarServiceSkeleton(ara::com::InstanceIdentifierContainer instanceIds,
>
> 26 ara::com::MethodCallProcessingMode mode =
>
> 27 ara::com::MethodCallProcessingMode::kEvent);
>
> 28
>
> 29 /\*\*
>
> 30 \* Exception-less ctor taking instance identifier container as parameter
>
> 31 \* and having default request processing mode kEvent.
>
> 32 \*/
>
> 33 static ara::core::Result\<RadarServiceSkeleton\> Create(
>
> 34 const ara::core::InstanceIdentifierContainer &instanceIDs,
>
> 35 ara::com::MethodCallProcessingMode mode =
>
> 36 ara::com::MethodCallProcessingMode::kEvent) noexcept;
>
> 37
>
> 38 /\*\*
>
> 39 \* Ctor taking instance specifier as parameter and having default
>
> 40 \* request processing mode kEvent.
>
> 41 \*/
>
> 42 RadarServiceSkeleton(ara::core::InstanceSpecifier instanceSpec,
>
> 43 ara::com::MethodCallProcessingMode mode =
>
> 44 ara::com::MethodCallProcessingMode::kEvent);
>
> 45
>
> 46 /\*\*
>
> 47 \* Exception-less ctor taking instance specifier as parameter and having default
>
> 48 \* request processing mode kEvent.
>
> 49 \*/
>
> 50 static ara::core::Result\<RadarServiceSkeleton\> Create(
>
> 51 const ara::core::InstanceSpecifier &instanceSpec,
>
> 52 ara::com::MethodCallProcessingMode mode =
>
> 53 ara::com::MethodCallProcessingMode::kEvent) noexcept;
>
> 54
>
> 55 /\*\*
>
> 56 \* skeleton instances are nor copy constructible.
>
> 57 \*/
>
> 58 RadarServiceSkeleton(const RadarServiceSkeleton& other) = delete;
>
> 59
>
> 60 /\*\*
>
> 61 \* skeleton instances are nor copy assignable.
>
> 62 \*/
>
> 63 RadarServiceSkeleton& operator=(const RadarServiceSkeleton& other) =
>
> delete;
>
> 64
...
> 65 /\*\*
>
> 66 \* The Communication Management implementer should care in his dtor
>
> 67 \* implementation, that the functionality of StopOfferService()
>
> 68 \* is internally triggered in case this service instance has
>
> 69 \* been offered before. This is a convenient cleanup functionality.
>
> 70 \*/
>
> 71 \~RadarServiceSkeleton();
>
> 72
>
> 73 /\*\*
>
> 75 \* method is idempotent - could be called repeatedly.
>
> 76 \*/
>
> 77 ara::core::Result\<void\> OfferService();
>
> 78
>
> 79 /\*\*
>
> 80 \* Stop Offering the service instance.
>
> 81 \* method is idempotent - could be called repeatedly.
>
> 82 \*
>
> 83 \* If service instance gets destroyed - it is expected that the
>
> 84 \* Communication Management implementation calls StopOfferService()
>
> 85 \* internally.
>
> 86 \*/
>
> 87 void StopOfferService();
>
> 88
>
> 89 /\*\*
>
> 90 \* For all output and non-void return parameters
>
> 91 \* an enclosing struct is generated, which contains
>
> 92 \* non-void return value and/or out parameters.
>
> 93 \*/
>
> 94 struct CalibrateOutput {
>
> 95 bool result;
>
> 96 };
...
> 98 /\*\*
>
> 99 \* For all output and non-void return parameters
>
> 100 \* an enclosing struct is generated, which contains
>
> 101 \* non-void return value and/or out parameters.
>
> 102 \*/
>
> 103 struct AdjustOutput {
>
> 104 bool success;
>
> 105 Position effective_position;
>
> 106 };
>
> 107
...
> 108 /\*\*
>
> 109 \* This fetches the next call from the Communication Management
>
> 110 \* and executes it. The return value is a ara::core::Future.
>
> 111 \* In case of an Application Error, an ara::core::ErrorCode is stored
>
> 112 \* in the ara::core::Promise from which the ara::core::Future
>
> 113 \* is returned to the caller.
>
> 114 \* Only available in polling mode.
>
> 115 \*/
>
> 116 ara::core::Future\<bool\> ProcessNextMethodCall();
>
> 117
>
> 118 /\*\*
>
> 119 \* \\brief Public member for the BrakeEvent
>
> 120 \*/
>
> 121 events::BrakeEvent BrakeEvent;
>
> 122
>
> 123 /\*\*
>
> 124 \* \\brief Public member for the UpdateRate
>
> 125 \*/
>
> 126 fields::UpdateRate UpdateRate;
>
> 127
>
> 128 /\*\*
>
> 129 \* The following methods are pure virtual and have to be implemented
>
> 131 virtual ara::core::Future\<CalibrateOutput\> Calibrate(
>
> 132 std::string configuration) = 0;
>
> 133 virtual ara::core::Future\<AdjustOutput\> Adjust(
>
> 134 const Position& position) = 0;
>
> 135 virtual void LogCurrentState() = 0;
>
> 136 };
>
...
> 5 \*/
>
> 6 ara::core::Future\<bool\> ProcessNextMethodCall();
>
...
> 12
>
> 13 // calling synchronous internal adjust function, which delivers results
>
> 14 struct AdjustOutput out = doAdjustInternal(
>
> 15 position,
>
> 16 &out.effective_position);
>
> 17 promise.set_value(out);
>
> 18
>
> 19 // we return a future from an already set promise\...
>
> 20 return promise.get_future();
>
> 21 }
>
> 22
...
> 22 // implicitly.
>
> 23 promise.SetError(SpecificErrorsErrc::InvalidConfigString);
>
> 24 }
>
> 25
...
> 35
>
> 36 std::string curValidConfig\_;
>
> 37 }
>
...
> 7
>
> 8 ara::core::Result\<void\> Send(const SampleType &data);
>
> 9
>
> 10 ara::core::Result\<ara::com::SampleAllocateePtr\<SampleType\>\> Allocate();
>
> 11
>
> 12 /\*\*
...
> 17 \*/
>
> 18 ara::core::Result\<void\> Send(ara::com::SampleAllocateePtr\<SampleType\>
>
> data);
>
> 19 };
...
>
> 1 []{#_bookmark138 .anchor}using namespace ara::com;
>
> 2
>
...
> 13 \*/
>
> 14 ara::core::Result\<void\> Update(const FieldType& data);
>
> 15
>
> 16 /\*\*
...
> 28 \*/
>
> 29 ara::core::Result\<void\> RegisterGetHandler(std::function\<ara::core::
>
...
> 31 /\*\*
>
> 32 \* Registering a SetHandler is mandatory, if the field supports it.
>
> 33 \* The handler gets the data the sender requested to be set.
>
> 34 \* It has to validate the settings and perform an update of its
>
> 35 \* internal data. The new value of the field should than be set
>
> 36 \* in the future.
>
> 38 \* The returned value is sent to the requester and is sent via notification to all subscribed entities.
>
> 39 \*/
>
> 40 ara::core::Result\<void\> RegisterSetHandler(std::function\<ara::core::
>
...
>
> 1 []{#_bookmark149 .anchor}using namespace ara::com;
>
> 2
>
...
>
> 1 []{#_bookmark150 .anchor}using namespace ara::com;
>
> 2
>
> 3 int main() {
...
>
> 21 // Access the value of the optional element with the optional::value() method
>
> 22 if(state.health.value() \>= BAD_HEALTH) {
>
> 23 // do something with this information
>
> 24 }
>
> 25 }
...
2.  ### Special Topics
    ...
    1.  []{#_bookmark169 .anchor}**Architecture**
...
>
> 1 #include \"ara/core/instance_specifier.h\"
>
> 2 #include \"ara/com/sample/tire_skeleton.h\"
>
> 3
>
> 4 class TireSkeletonImplementation : public ara::com::sample::skeleton:: TireSkeleton
>
> 5 {
>
> 6 using TireSkeleton::TireSkeleton;
>
> 7
>
> 8 // Implement service interface methods, if any
>
> 9 };
>
> 10
...
> 12 {
>
> 13 const ara::core::InstanceSpecifier tire0_Instance{\"/ServerExe/ RootSWCP_0/Comp_Lvl1/Comp_Lvl2/SwComponentInstance_0/PPort_3\"};
>
> 14 const ara::core::InstanceSpecifier tire1_Instance{\"/ServerExe/ RootSWCP_0/Comp_Lvl1/Comp_Lvl2/SwComponentInstance_1/PPort_3\"};
>
> 15
>
> 16 TireSkeletonImplementation tire0(tire0_Instance);
>
> 17 TireSkeletonImplementation tire1(tire1_Instance);
>
> 18
>
> 19 // Sleep while Skeleton instances run, process requests, etc.
>
> 20
>
> 21 return 0;
...
> 1 #include \"ara/core/instance_specifier.h\"
>
> 2 #include \"ara/com/sample/tire_proxy.h\"
>
> 3
>
> 4 int main()
...
> 5 {
>
> 6 using Proxy = ara::com::sample::proxy::TireProxy;
>
> 7
>
> 8 const ara::core::InstanceSpecifier tire0_Instance{\"/ClientExe/ RootSWCP_0/Comp_Lvl1/Comp_Lvl2/SwComponentInstance_0/RPort_3\"};
>
> 9 const ara::core::InstanceSpecifier tire1_Instance{\"/ClientExe/ RootSWCP_0/Comp_Lvl1/Comp_Lvl2/SwComponentInstance_1/RPort_3\"};
>
> 10
>
> 11 auto tire0_handles = Proxy::FindService(tire0_Instance).ValueOrThrow();
>
> 12 auto tire1_handles = Proxy::FindService(tire1_Instance).ValueOrThrow();
>
> 14 Proxy tire0(tire0_handles\[0\]);
>
> 15 Proxy tire1(tire1_handles\[0\]);
>
> 16
>
> 17 // Call methods, subscribe to events, etc.
>
> 18
>
> 19 return 0;
...
> 1 #include \"ara/core/instance_specifier.h\"
>
> 2 #include \"ara/com/sample/radar_proxy.h\"
>
> 3
>
> 4
...
> 5 int main() {
>
> 6 using Proxy = ara::com::sample::proxy::radarProxy;
>
> 7 // \...
>
> 8 ara::core::InstanceSpecifier portSpecifier{\"fusionExe/fusion/ radar_RPort\"};
>
> 9 auto res = Proxy::FindService(portSpecifier);
>
> 10 //\....
>
> 11 }
...
>
> 1 []{#_bookmark188 .anchor}// NOTE! For simplicity the example does not use ara::core::Result.
>
> 2
>
...
>
> 1 []{#_bookmark190 .anchor}// NOTE! For simplicity the example does not use ara::core::Result.
>
> 2
>
> 3 #include \"ara/core/instance_specifier.h\"
