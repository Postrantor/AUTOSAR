...
> []{#_bookmark18 .anchor}AUTOSAR_RS_Safety
...
> «use»
>
> ara::com PackageManagement
>
> Vehicle DriverApplication
>
> Vehicle StateManager
>
> «executionEnvir
>
> **AUTOSAR Adaptive**
...
> Activating
>
> DependencyCheck() StartU pdate Session()
>
> :ReadyForU pdate
>
> **loop for each SoftwareCluster**
>
> Prepare U pdate(vector\<FunctionGroup\>)
>
> SetState(Off)
>
> SIGTERM()
>
> ara::core::Deinitialize should be the last call

ara::core::Deinitialize()

: e xitstatus

> Close storages & Free resources()
>
> :Prepared
>
> :Activate success
...
>
> Machine reset is optional and defined in SWP Manifest
>
> **alt ReparseManifest**
>
> \[Reset\]
...
> Reparse Manifests()
>
> Reparsing is implementation specific. UCM might have to interact with other Functional Clusters to make sure the Verify step will not fail. If no positive response is returned from those FCs, it should be reason for UCM to trigger a rollback.
>
> **loop for each SoftwareCluster**
>
> Verify U pdate(vector\<FunctionGroup\>)
>
> SetState(Verify)
>
> Spawn process()
...
> Install and/or update persisten data()
>
> :Verified
...
> UCM waiting for other UCM subs to get activated, coordinated by UCM Master with finish()
>
> Cleaning-up
>
> StopU pdate Session()
